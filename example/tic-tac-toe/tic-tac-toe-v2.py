...
print('goal(xplayer, 50, J, T) :- not empty(J,T), program(J), tdom(T), not goal(xplayer, 100, J, T), not goal(oplayer, 100, J, T).')
print('goal(oplayer, 50, J, T) :- not empty(J,T), program(J), tdom(T), not goal(xplayer, 100, J, T), not goal(oplayer, 100, J, T).')
