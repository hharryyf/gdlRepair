...
print('init(cell(1,1,4)).')
print('init(cell(1,2,3)).')
print('init(cell(1,3,1)).')
print('init(cell(2,1,2)).')
print('init(cell(2,2,6)).')
print('init(cell(2,3,5)).')
print('init(cell(3,1,7)).')
print('init(cell(3,2,8)).')
print('init(cell(3,3,b)).')
print('init(step(1)).')
