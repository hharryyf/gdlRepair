...
if len(sys.argv) != 4:
    print('Usage python repair-N-player-weak.py [GDL ASP file] [path to the repair cost definition file] [cost bound, negative cost means prove termination and playability]')
    exit(1)
...
disj = sys.argv[1].replace('.lp', '-disjunction.lp')
